...
// const MOVIE_LIMIT: i64 = 20;

// #[tokio::main]
// async fn main() {
//     dotenv().ok();

//     // IMPORTANT: app must exist
//     let app = Router::new()
//         .route("/", get(index_handler))
//         .route("/movies", get(movies_html_handler))
//         .route("/movies.json", get(movies_json_handler))
//         .fallback(not_found_handler)
//         .layer(middleware::from_fn(log_requests));
...
//     println!("  http://localhost:8000/movies");
...
//         .await
//         .unwrap_or_else(|_| "<h1>Welcome</h1>".to_string());
//     Html(html)
// }

// async fn not_found_handler() -> (StatusCode, Html<&'static str>) {
//     (StatusCode::NOT_FOUND, Html("<h1>404 Not Found</h1>"))
// }

// async fn movies_json_handler() -> Json<Vec<Movie>> {
//     Json(fetch_movies().await)
// }

// async fn movies_html_handler() -> Html<String> {
//     let html = fs::read_to_string("movie.html")
//         .await
//         .unwrap_or_else(|_| "<h1>movie.html missing</h1>".to_string());
//     Html(html)
// }

// async fn fetch_movies() -> Vec<Movie> {
...
//     res.json::<Vec<Movie>>().await.unwrap()
// }
